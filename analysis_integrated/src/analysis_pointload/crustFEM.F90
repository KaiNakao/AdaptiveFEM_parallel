...
#define DIR_MDATA_CDATA "./"
      ...
      subroutine initialize( &
            im,ncpu,np,kd,nfa,n2dvisl,n2dvisa, &
...
! #endif
      ...
      subroutine main_compute_ni(im,ncpu,np,kd,nfa,n2dvisl, &
            ...
            n4_size,ne4_size,n4,ne4,ib4,nab4,nad4,nadto4,fidc, &
            bufds,bufls, &
            plane,ds,ni_size,nei_size,ni,nei,ni4_size,nei4_size, &
            ni4,nei4)
      implicit none
      INCLUDE 'mpif.h'
      ...
      subroutine main_solver(im,ncpu,np,kd,nfa,plane,ds,n2dvisl, &
            n_size,ne_size,ni_size,nei_size,n,ne,ni,nei, &
            ib,nab,nad,nadto,fidm, &
            n4_size,ne4_size,ni4_size,nei4_size,n4,ne4,ni4,nei4, &
            ib4,nab4,nad4,nadto4,fidc, &
            bufds,bufls, &
            coor,coori,dsi,uval,bcarray,cny,num, &
            cnyi,numi,nfla,duplixyz, &
            mpiadi,mpiadlisti,mpli,nadtoi, &
            coori4,dsi4,uval4,bcarray4,cny4,num4, &
            cnyi4,numi4,nfla4,duplixyz4,&
            mpiadi4,mpiadlisti4,mpli4,nadtoi4, &
            nird,niwd,pentawptrd,pentarptrd,pentawindd,pentarindd, &
            nir,niw,pentawptr,pentarptr,pentawind,pentarind, &
            nir4,niw4,pentawptr4,pentarptr4,pentawind4,pentarind4, &
            kcrsvald,kcrsval,kcrsval4, &
            map4to10, &
            cnysep_write, cnysep_write4, &
            nsep_ne_ptr,numsep,nsep_n_ptr,nsep_n_ptr4,nsep, &
            nsepnmap,nsep4,nsepnmap4, &
            ncolor,color_ind, &
            cnysep_readm,cnysep_readm4, &
            younglst,sig,up,rv,mpibuf,uvalcoe, &
