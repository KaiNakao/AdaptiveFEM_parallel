...
#PBS -q calc
##PBS -N hpl
#PBS -l select=8:ncpus=80:mpiprocs=80
...
time ../dem_to_hdf5/modeling_hybrid_hdf.exe > dem_to_hdf5.log
...
do
    ...
    time julia ../merge_local_result/to_AFEM.jl ${NPART} > merge_local_result.log
